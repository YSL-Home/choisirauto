...
export default function GuidePage({ params }: { params: { slug: string } }) {
  ...
  return (
    <div className="mx-auto max-w-3xl px-5 py-14">
      ...
      {vehicle && (
        <div className="mt-4 flex h-40 items-center justify-center overflow-hidden rounded-2xl bg-gradient-to-br from-accent/10 via-paper to-good/10">
          <CarIllustration segment={vehicle.segment} className="h-28 w-44" />
        </div>
      )}
